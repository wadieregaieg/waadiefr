...
/// Signature used by [CustomDissmissable] to indicate that it has been dismissed in
/// the given `direction`.
///
/// Used by [CustomDissmissable.onDismissed].
typedef DismissDirectionCallback = void Function(DismissDirection direction);

/// Signature used by [CustomDissmissable] to give the application an opportunity to
/// confirm or veto a dismiss gesture.
///
/// Used by [CustomDissmissable.confirmDismiss].
typedef ConfirmDismissCallback = Future<bool?> Function(
    DismissDirection direction);

/// Signature used by [CustomDissmissable] to indicate that the dismissible has been dragged.
///
/// Used by [CustomDissmissable.onUpdate].
...
///
/// {@tool dartpad}
/// This sample shows how you can use the [CustomDissmissable] widget to
...
class CustomDissmissable extends StatefulWidget {
  /// Creates a widget that can be dismissed.
  ///
  /// The [key] argument is required because [CustomDissmissable]s are commonly used in
  ...
  @override
  State<CustomDissmissable> createState() => _CustomDissmissableState();
}
...
/// See also:
///
///   * [CustomDissmissable.onUpdate], which receives this information.
class DismissUpdateDetails {
  ...
  /// that the [CustomDissmissable] is dragged across the threshold.
...
class _CustomDissmissableState extends State<CustomDissmissable>
